...
#elif defined(BSP_BOARD_RSKRX62N) || defined(BSP_BOARD_MT01)
    #define FL_RSPI_CHANNEL     (1)
#else
...
void fl_mem_init(void)
{
    ...
    R_RSPI_Init(FL_RSPI_CHANNEL);

    R_SF_ReadData (FL_RSPI_CHANNEL, 0, testeRead, sizeof(testeRead));
