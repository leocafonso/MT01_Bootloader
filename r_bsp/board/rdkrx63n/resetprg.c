...
static void clock_source_select (void)
{
    ...
    /* LOCO is chosen. Start it operating. */
    SYSTEM.LOCOCR.BYTE = 0x00;          

    /* The oscillation stabilization time for the LOCO is only 20us and since each cycle is ~8us this delay will 
       have passed by the time this function is exited. */
#else
